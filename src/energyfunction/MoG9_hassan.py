...
def sampling_from_U_MoG9(n_sample: int):
    ...
    energies = torch.exp(-U_MoG9(random_points))
...
def plot_U_MoG9():
    ...
    Z = torch.exp(-U_MoG9(xy_tensor)).view(200, 200).numpy()
